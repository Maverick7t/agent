          ...
          <>
            ...
            <div className="max-w-4xl mx-auto space-y-6 mb-12">
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
                Experience the future of conversation with our advanced AI that
                understands context, emotion, and responds with remarkable
            ...
            >
              <div className="relative flex bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 shadow-2xl p-2">
                ...
                <button
                  onClick={sendMessage}
                  disabled={!input.trim()}
                  className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl transition-all duration-300 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105"
                >
